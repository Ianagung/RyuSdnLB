...
broker_port = 1883
add01 = 'http://192.168.146.4:8080/index.html'
add02 = 'http://192.168.146.15:8080/index.html'
add03 = 'http://192.168.146.16:8080/index.html'
...
max_truput_server = 2500 #max = 2140 Byte/s 2.1 KB/s set 18000 bit/s atau 18 Kbps #ab -n 500 -c 10
truput_server01 = [1]
truput_server02 = [1]
truput_server03 = [1]
cpu_server01 = [1]
...
mean_mem_server02 = 1
mean_mem_server03 = 1
f_name = 'Uji06-RT01.csv'
f_name2 = 'Uji06-RT02.csv' #Value of CPU Memory Network per sec for time series analysis
