...
for i in {0..29..1}
  do 
    ...
    # Run ab
    ab -n 200 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd02.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
...
for i in {0..29..1}
  do 
   ...
   # Load python toggle start
    ...
    # Run ab
    ab -n 300 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd03.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
...
for i in {0..29..1}
  do 
    ...
    # Run ab
    ab -n 400 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd04.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
...
for i in {0..29..1}
  do 
    ...
    # Run ab
    ab -n 500 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd05.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
