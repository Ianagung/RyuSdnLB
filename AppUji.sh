#!/bin/bash
#defining a variable
Kalimat="Pengujian Load Balancing dimulai - Uji Beban Algoritma Round Robin"
echo $Kalimat |& tee Uji02-RR01.txt
# for loop
for i in {0..29..1}
  do 
    ...
    # Run siege
    ab -n 100 -c 5 http://192.168.146.100:1000/ |& tee -a Uji02-RR01.txt
