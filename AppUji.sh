...
for i in {0..29..1}
  do 
    ...
    # Load python toggle start
    python3 AppToggleUjiStart.py
    echo "Tes request 1000" |& tee -a Uji03-Rd02.txt
    # Run ab
    ab -n 1000 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd02.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
...
for i in {0..29..1}
  do 
   ...
   # Load python toggle start
    python3 AppToggleUjiStart.py
    echo "Tes request 2000" |& tee -a Uji03-Rd03.txt
    # Run ab
    ab -n 2000 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd03.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
...
for i in {0..29..1}
  do 
    ...
    # Load python toggle start
    python3 AppToggleUjiStart.py
    echo "Tes request 3000" |& tee -a Uji03-Rd04.txt
    # Run ab
    ab -n 3000 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd04.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
...
for i in {0..29..1}
  do 
    ...
    # Load python toggle start
    python3 AppToggleUjiStart.py
    echo "Tes request 4000" |& tee -a Uji03-Rd05.txt
    # Run ab
    ab -n 4000 -c 10 http://192.168.146.100:1000/ |& tee -a Uji03-Rd05.txt
    # Load python toggle stop
    python3 AppToggleUjiStop.py
    sleep 1
