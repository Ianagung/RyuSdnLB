#!/bin/bash
#defining a variable
Kalimat="Pengujian Load Balancing dimulai - Uji Tanpa Beban Algoritma Respon Time"
echo $Kalimat |& tee Uji01-RT01.txt
# for loop
for i in {0..29..1}
  do 
    ...
    # Run siege
    ab -n 100 -c 5 http://192.168.146.100:1000/ |& tee -a Uji01-RT01.txt
