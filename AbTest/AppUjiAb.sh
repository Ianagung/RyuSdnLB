#!/bin/bash
#defining a variable
Kalimat="Pengujian Load Balancing dimulai - Uji5 Dengan Beban - Algoritma Round Robin"
echo $Kalimat |& tee Uji05-RR01.txt
# for loop
for i in {0..29..1}
  do 
    
    #sleep 5
    echo "Testing number $i " |& tee -a Uji05-RR01.txt
    ...
    echo "selesai" |& tee -a Uji05-RR01.txt
    sleep 1    
 done
# End loop

echo $Kalimat |& tee Uji05-RR02.txt
# for loop
for i in {0..29..1}
  do 
    
    #sleep 5
    echo "Testing number $i " |& tee -a Uji05-RR02.txt
    ...
    echo "selesai" |& tee -a Uji05-RR02.txt
    sleep 1    
 done
# End loop

echo $Kalimat |& tee Uji05-RR03.txt
# for loop
for i in {0..29..1}
  do 
    
    #sleep 5
    echo "Testing number $i " |& tee -a Uji05-RR03.txt
    ...
    echo "selesai" |& tee -a Uji05-RR03.txt
    sleep 1    
 done
# End loop

echo $Kalimat |& tee Uji05-RR04.txt
# for loop
for i in {0..29..1}
  do 
    
    #sleep 5
    echo "Testing number $i " |& tee -a Uji05-RR04.txt
    ...
    echo "selesai" |& tee -a Uji05-RR04.txt
    sleep 1    
 done
# End loop

echo $Kalimat |& tee Uji05-RR05.txt
# for loop
for i in {0..29..1}
  do 
    
    #sleep 5
    echo "Testing number $i " |& tee -a Uji05-RR05.txt
    # Load python toggle start
    python3 AppToggleUjiStart.py
    ...
    echo "selesai" |& tee -a Uji05-RR05.txt
    sleep 1    
 done
# End loop