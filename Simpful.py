...
LV1 = LinguisticVariable([P1,P2], concept=”PaO2 level in blood”, universe_of_discourse=[0,80]) FS.add_linguistic_variable(”PaO2”, LV1)
LV1.plot()
# Define fuzzy sets for the variable base excess
B1 = FuzzySet(function=Gaussian_MF(mu=0,sigma=1.25), term=”normal”)
LV2 = LinguisticVariable([B1], concept=”Base excess of the blood”, universe_of_discourse=[-10,10]) FS.add_linguistic_variable(”BaseExcess”, LV2)
LV2.plot()
...
LV3 = LinguisticVariable([T1,T2], concept=”Trombocytes in blood”, universe_of_discourse=[0,100]) FS.add_linguistic_variable(”Trombocytes”, LV3)
LV3.plot()
...
LV4 = LinguisticVariable([C1,C2], concept=”Creatinine in blood”, universe_of_discourse=[0,600]) FS.add_linguistic_variable(”Creatinine”, LV4)
LV4.plot()
# Define the consequents FS.set_crisp_output_value(”low_probability”, 1) FS.set_crisp_output_value(”high_probability”, 99)
...
print(FS.Mamdani_inference([”Sepsis”]))